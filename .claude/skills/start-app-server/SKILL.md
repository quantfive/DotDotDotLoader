...
Fast-path skill for starting DotDotDotLoader's app server. All discovery was done during bootstrap on 2026-06-01T20:35:14Z — just execute.
...
- **Stack**: React 16 + Express 4, webpack build serving static files on port 3000
...
- Used `npm install --legacy-peer-deps` to handle old peer dependencies from 2017-era React/Babel/Webpack setup
